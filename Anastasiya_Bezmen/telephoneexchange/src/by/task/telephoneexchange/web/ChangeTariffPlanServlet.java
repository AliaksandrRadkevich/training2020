...
/**
 * ChangeTariffPlanServlet.
 * Date: 01/28/2021
 *
 * @author Anastasiya Bezmen
 */
public class ChangeTariffPlanServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        req.getRequestDispatcher("/WEB-INF/jsp/user/changeTariffPlan.jsp").forward(req, resp);
    }
}
