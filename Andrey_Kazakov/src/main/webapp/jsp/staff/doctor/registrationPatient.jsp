...
<html>
<head>
    <title><fmt:message key="message.registration.patient"/></title>
...
<div class="container1">
    ...
    <div class="main">
        ...
        <form name="registrationForm" method="post" id="usrform"
              action="${pageContext.request.contextPath}/controller/" class="formBox2">
            ...
            <input type="date" name="birthday" value="${sessionScope.person.birthday}" min="1920-01-01"
            ...
            <div class="error">
                <c:if test="${not empty sessionScope.incorrectData.incorrectDiagnosis}">
            ...
            <input type="text" name="procedure" value="${sessionScope.prescription.procedure}"
                   placeholder="<fmt:message key='message.prescription.procedure'/>"/><br/><br/>
            <input type="text" name="operation" value="${sessionScope.prescription.operation}"
